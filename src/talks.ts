...
async function handleGetStateSummary(
  ctx: HandlerContext,
  store: TalkStore,
  talkId: string,
  stream: string,
...
async function handleGetStateEvents(
  ctx: HandlerContext,
  store: TalkStore,
  talkId: string,
  stream: string,
...
async function handleAppendStateEvent(
  ctx: HandlerContext,
  store: TalkStore,
  talkId: string,
  stream: string,
...
async function handleGetStatePolicy(
  ctx: HandlerContext,
  store: TalkStore,
  talkId: string,
  stream: string,
...
async function handleUpdateStatePolicy(
  ctx: HandlerContext,
  store: TalkStore,
  talkId: string,
  stream: string,
